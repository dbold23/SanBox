...
> Superseded by `results/real_v10/README.md` (2026-09-02): the pipeline fixes for the terraced fins, seam lines, folded dorsal tip, dropped tail and mis-named caudal are described and measured there.  This directory is kept as the before state.
